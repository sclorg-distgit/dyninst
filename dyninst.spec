...
# ppc ppc64 is not on the list because a more recent g++, which is
# needed for c++11 support, is not available there
...
Patch2: dyninst-9.3.2-sstream.patch
...
%changelog
* Fri Jun 16 2017 Stan Cox <scox@redhat.com> - 9.3.2
